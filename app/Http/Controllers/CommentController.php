...
class CommentController extends Controller
{
    ...
    public function getComment()
    {
        ...
        [
            ...
            'comment_per_page.numeric' => 'comment_per_page is number!'
        ]);
        ...
        catch(\Exception $e)
        {
            return response()->json([
                'status' => 'error',
                'code' => 'dont-have-data-or-error-happened',
                'message' => "Don't have any data or error happened!"
            ], 200);
        }
    }
